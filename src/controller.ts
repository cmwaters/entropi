...
export namespace Controllers {
    ...
    export function input(input: Input, func: (entity: any, input: Input) => void): Controller {
        return new InputController(input, func)
    }
    
    export function generic(object: any, func: (entity: any, object: any) => void) {
        return new GenericController(object, func)
    }
    ...
    //         let diff = Vector.sub(entity.body.position, target)
